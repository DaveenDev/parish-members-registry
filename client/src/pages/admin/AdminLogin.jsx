...
export default function AdminLogin() {
  ...
  return (
    <div
      ...
      style={{ background: 'radial-gradient(130% 100% at 50% -20%,#20406b 0%,#1a3358 45%,#132844 100%)' }}
    >
      <div className="w-full max-w-[400px] animate-fadeUp">
        <div className="text-center mb-[26px] text-[#e4c06a]" style={{ marginBottom: '26px' }}>
          ...
          <div className="text-[13px] tracking-[.14em] uppercase text-[#e4c06a]/90 mt-1.5">Members Registry · Admin</div>
        </div>
